\hypertarget{passengers__take__in_8h}{}\doxysection{include/passengers\+\_\+take\+\_\+in.h File Reference}
\label{passengers__take__in_8h}\index{include/passengers\_take\_in.h@{include/passengers\_take\_in.h}}
...
\item 
int \mbox{\hyperlink{passengers__take__in_8h_ad76f630c9b48489803eeb11079f324a5}{passengers\+\_\+take\+\_\+in}} (struct \mbox{\hyperlink{structelevator}{elevator}} elevator\+\_\+arr\mbox{[}$\,$\mbox{]}, int index, struct \mbox{\hyperlink{structpassenger}{passenger}} $\ast$floor\+\_\+arr\mbox{[}$\,$\mbox{]}, int cur\+\_\+floor, unsigned int event\+\_\+time)
...
\mbox{\Hypertarget{passengers__take__in_8h_ad76f630c9b48489803eeb11079f324a5}\label{passengers__take__in_8h_ad76f630c9b48489803eeb11079f324a5}} 
\index{passengers\_take\_in.h@{passengers\_take\_in.h}!passengers\_take\_in@{passengers\_take\_in}}
\index{passengers\_take\_in@{passengers\_take\_in}!passengers\_take\_in.h@{passengers\_take\_in.h}}
...
\DoxyCodeLine{43         \{}
\DoxyCodeLine{44 }
\DoxyCodeLine{45             \textcolor{keywordflow}{if} (floor\_arr[floor\_index] != NULL \&\& elevator\_arr[index].\mbox{\hyperlink{globals_8h_aafbf17dfb8c07dadb99b3e0faadef32d}{passenger\_count}} < passenger\_capacity)}
\DoxyCodeLine{46             \{}
\DoxyCodeLine{47                 \textcolor{keyword}{struct }\mbox{\hyperlink{structpassenger}{passenger}} temp = *(floor\_arr[floor\_index]);}
...
\DoxyCodeLine{53                 \mbox{\hyperlink{travel__log__file_8h_af8d5fde3cc01745bf27550d1fb69bf3f}{travel\_log\_file}}(*(floor\_arr[floor\_index]), event\_time, index, 2); \textcolor{comment}{//choose mode to calculate avg,max times.}}
\DoxyCodeLine{54                 \mbox{\hyperlink{remove__passenger__floor_8h_a25f8c0d7e3c685b2c1830182e3705df0}{remove\_passenger\_floor}}(floor\_arr, cur\_floor);}
\DoxyCodeLine{55             \}}
