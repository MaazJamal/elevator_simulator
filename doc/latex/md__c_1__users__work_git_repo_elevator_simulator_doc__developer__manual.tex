Elevator simulation is a software to simulate the operations of multiple elevators in a commercial building, by creating an algorithm.\hypertarget{md__c_1__users__work_git_repo_elevator_simulator_doc__developer__manual_autotoc_md1}{}\doxysection{Requirement}\label{md__c_1__users__work_git_repo_elevator_simulator_doc__developer__manual_autotoc_md1}
Software simulates Elevator scheduling in a building for an day by reading the input file with Paaseger ID,timestamp,start and destination floor. The text file must be stored in data/input.\+txt.\hypertarget{md__c_1__users__work_git_repo_elevator_simulator_doc__developer__manual_autotoc_md2}{}\doxysection{Assumption}\label{md__c_1__users__work_git_repo_elevator_simulator_doc__developer__manual_autotoc_md2}
...
\end{DoxyItemize}\hypertarget{md__c_1__users__work_git_repo_elevator_simulator_doc__developer__manual_autotoc_md3}{}\doxysection{Program Flow}\label{md__c_1__users__work_git_repo_elevator_simulator_doc__developer__manual_autotoc_md3}
...
\end{DoxyItemize}\hypertarget{md__c_1__users__work_git_repo_elevator_simulator_doc__developer__manual_autotoc_md4}{}\doxysection{Documentation}\label{md__c_1__users__work_git_repo_elevator_simulator_doc__developer__manual_autotoc_md4}
