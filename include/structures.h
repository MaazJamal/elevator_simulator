/**@file structures.h 
 *@brief contains declarations for structure passenger, elevator
...
/** 
 * \brief structure to store important information about a passenger.
 * 
...
/** 
 * \brief structure to store important information about an elevator.
 * 
...
struct elevator
{
	...
	unsigned int cur_floor;			 //!< The current floor of the elevator. Floors start at 1.
